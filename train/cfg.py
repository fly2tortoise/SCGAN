...
def parse_args():
    ...
    parser.add_argument('--exp_name', type=str, default='cifar10', help='experiment name')
    ...
    parser.add_argument('--genotypes_exp', type=str,  default='arch_cifar10', help='ues genotypes of the experiment')
    ...
    parser.add_argument('--init_type', type=str, default='xavier_uniform', choices=['normal', 'orth', 'xavier_uniform', 'false'],  help='init type')
    ...
    parser.add_argument('--val_freq', type=int, default=5, help='frequency of validation') # 20
